...
const AdminsideNav = () => {
  ...
  return (
    <div className="w-full overflow-hidden  font-manrope">
      {/* <h1 className="text-xl text-black font-bold pl-7 pb-9">Wonderplots</h1> */}
      <div style={{ width: "150px", height: "50px", position: "relative", left: "20px" }} className="md:pl-6 pl-4 mb-4 ">
        <Image
