...
const HouseCard = ({ name, propertyImages, cost, agentId, _id, location, size, areaValue, BHKconfig, availableFor, toggle, propertyType, slug, areaType }: Propery) => {
          ...
          <div className="flex justify-between items-end ">
            ...
            <div className="flex flex-col mb-2">
              <p className="flex items-center justify-center   space-x-2 text-right">
                ...
                <span className="text-md font-medium mb-1">₹{areaValue}/{areaType}</span>
              </p>
              <p className="text-xs font-medium ">Area:{size} {areaType}</p>
            </div>
          </div>
        </div>
