...
const Slider = ({ property }: { property: Propery }) => {
  ...
  const backgroundImage = propertyImages && propertyImages.length > 0
  ...
  return (
    ...
    //       </div> */}
    //     </div>
    //     <div  className="resfeaturedProjectsCard__contentBox pageComponent">
    ...
    //       </Link> */}
    //       <div  >
    //       <Link className="mt-8 " href={`/details/${slug}`}>
    //         {/* <Link href={`/details/${_id}`}> */}
    //         <div className="list_header_bold spacer8 f16 text-[1.5rem] ">{name}</div>
    //       </Link>
    ...
    // <>
    //   <div>
    //     <div className="relative h-64 w-full overflow-hidden m-4">
    //       <img
    //         src="https://cdn.pixabay.com/photo/2023/11/11/17/02/sunset-8381528_1280.jpg"
    //         alt="Card Background"
    //         className="w-full h-full object-cover"
    //       />
    //     </div>
    //     <div style={{ border: "2px solid blue" }} className="relative h-24">
    //       <div className="absolute bottom-[30px] left-[35px] rounded-lg w-[270px] p-4 h-40  bg-white bg-opacity-100 text-black box-border  shadow-lg">
    //         <h3 className="text-xl font-bold">dsafasdfa</h3>
    //         <p className="mb-2">sdafdsa</p>
    //         <p className="mb-2">Price:345435</p>
    //         <p>Rating: 2/5</p>
    //       </div>
    //     </div>
    //   </div>
