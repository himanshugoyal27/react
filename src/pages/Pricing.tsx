...
const subscriptionPacks = [
  ...
  },
  {
    ...
    features: [
      ...
      { available: false, text: "Video Shoot: Property Video Shoot from WP team" },
...
const PricingPopup: React.FC = ({ planId, closeModal, planName }) => {
  ...
  const handleSubmit = async () => {
    ...
    setButtonHide(true)
    // Check if planId and primaryFilesToUpload are present
    if (!planId || primaryFilesToUpload.length === 0) {
      toast.error("Please provide screenshot of the payment");
      setButtonHide(false);
      return;
    }
